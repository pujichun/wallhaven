...
class WallHaven(object):
    ...
    async def get_list_image_page(self, session: ClientSession, url: str):
        try:
    ...
    async def parse_image_link(self, session: ClientSession, html: str):
    ...
    async def image_link_process(self, image_link: str) -> str:
    ...
    async def download_image(self, session: ClientSession, image_link: str):
